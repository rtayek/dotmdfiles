...
if [ ! -f gradlew ]; then
    echo "error: run this from the Gradle project root" >&2
    exit 1
fi
...
The script deliberately delegates deletion to Gradle rather than performing
an unrestricted recursive deletion.
